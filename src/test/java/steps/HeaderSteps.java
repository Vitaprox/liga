...
public class HeaderSteps {
    ...
    public void clickBasketButton(){
        ...
        Assert.assertTrue(basketPage.checkBasketTitle(), "Моя корзина не отображается");
    }
    ...
    public void clickSearchButton(){
        ...
        listingPage.checkFiltersIsVisible();
    }
    ...
    public void checkLocationCityText(){
        Assert.assertEquals(headerPage.getLocationCityText(), "Краснодар");
    }
