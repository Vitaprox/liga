...
public class ListingPage {
    ...
    private SelenideElement filterList;
    ...
    public void writeCartProductsFavorite(){
        ...
        CartProductsNamePriceBuy.createCarts(nameProducts, priceProducts, favoriteProdButton);
    }

    public void writeCartProductsComparison(){
        nameProducts.get(0).shouldBe(Condition.visible);
        CartProductsNamePriceBuy.createCarts(nameProducts, priceProducts, comparisonProdButton);
    }

    public void shouldBeIconButtonActive(int numberProduct){
        CartProductsNamePriceBuy.products.get(numberProduct-1).button.shouldBe(Condition.cssClass("active"));
    }
    ...
    public void checkFiltersIsVisible(){
        filterList.shouldBe(Condition.visible);
    }
}
